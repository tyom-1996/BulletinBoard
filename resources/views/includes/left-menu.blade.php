<div class="content-left-menu">
    ...
    <a id="my-classifieds" class="menu-item first-child-icon" href="/my-classifieds" rel="nofollow" title="Мои объявления">
    ...
    <a id="my-messages" class="menu-item  messages-badge-wrapper" href="/my-messages"  title="Сообщения">
    ...
    <a id="my-favorites" class="menu-item favorites-badge-wrapper  " href="/my-favorites" rel="nofollow" title="Избранные объявления">
    ...
    <a id="my-wishlists" class="menu-item wishlists-badge-wrapper" href="/my-wishlists" rel="nofollow" title="Списки желаний">
        <span class="badge">0</span>
        <span class="button-icon">
    ...
    <a  class="menu-item cart-button " id="cart-button" href="#"  rel="nofollow">
        <span class="badge">0</span>
        <span class="button-icon">
...
<script>
    ...
    $('.content-left-menu .menu-item').each(function(){
        if ($(this).attr('href') == loc) $(this).addClass('selected');
    })
</script>
